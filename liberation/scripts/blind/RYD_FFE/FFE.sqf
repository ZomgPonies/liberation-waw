...
if (isNil ("RydFFE_Amount")) then {RydFFE_Amount = 2};
...
RydFFE_Mortar = ["lib_grwr34","i_mortar_01_f","o_mortar_01_f","b_g_mortar_01_f","b_mortar_01_f"] + RydFFE_Add_Mortar;
...
[] call compile preprocessFile "scripts\blind\RYD_FFE\FFE_fnc.sqf";
Shellview = compile preprocessFile "scripts\blind\RYD_FFE\Shellview.sqf";
