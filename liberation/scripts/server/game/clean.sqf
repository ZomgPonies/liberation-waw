...
_checkFrequencyAccelerated = 40;				// sleep accelerated
_playerThreshold = 6;							// How many players before accelerated cycle kicks in?

_deadMenLimit = 30;								// Bodies. Set -1 to disable.
_deadMenDistCheck = TRUE;						// TRUE to delete any bodies that are far from players.
_deadMenDist = 1500;							// Distance (meters) from players that bodies are not deleted if below max.
_deadVehiclesLimit = 15;						// Wrecks. Set -1 to disable.
...
_craterLimit = 15;								// Craters. Set -1 to disable.
