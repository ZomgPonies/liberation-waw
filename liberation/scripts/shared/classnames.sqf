...
if ( isNil "elite_vehicles_extension" ) then { elite_vehicles_extension = [] }; elite_vehicles = [] + elite_vehicles_extension + ["LIB_PzKpfwVI_B","LIB_PzKpfwV","LIB_PzKpfwVI_B_camo","LIB_PzKpfwVI_E","LIB_FW190F8","LIB_Ju87"];
...
squads = [
	...
	[blufor_squad_at,20,8,0],
	[blufor_squad_aa,20,4,0],
	[blufor_squad_recon,20,0,0],
	[blufor_squad_para,25,0,0]
];
...
GRLIB_intel_laptop = "Land_File1_F";
...
GRLIB_sar_wreck = "LIB_SdKfz251_Wreck";
